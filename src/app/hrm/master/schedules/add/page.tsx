import AddWorkScheduleTypeForm from '@/components/hrm/misc/AddWorkScheduleTypeForm';
...
export default async function AddWorkScheduleType() {
  ...
  return (
    <DashboardLayout user={user}>
      <AddWorkScheduleTypeForm scheduleTypeId={null} />
    </DashboardLayout>
  );
} 