    ...
    <main className="min-h-screen bg-background px-4 py-10 text-foreground">
      <div className="mx-auto flex max-w-3xl flex-col gap-6">
        <div className="flex flex-col gap-2">
          <p className="text-sm font-medium text-muted-foreground">Finnikk Business OS</p>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground">
            <p>
              Finnikk Business OS collects account details such as name, email address,
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground">
            ...
            <p>
              Finnikk Business OS does not sell user data. Data may be processed by
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground">
            ...
            <p>
              ...
              <a
                className="font-medium text-foreground underline-offset-4 hover:underline"
                href="mailto:privacy@finnikkglobal.netlify.app"
              >
                privacy@finnikkglobal.netlify.app
              </a>
              .
            </p>
          </CardContent>
