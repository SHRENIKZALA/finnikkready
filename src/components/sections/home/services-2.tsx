      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
          ...
          <ScrollView delay={0.2}>
            <p>
              FinniKK brings financial, tax, regulatory, litigation and corporate expertise together around your business. From recurring compliance to complex transactions and disputes, our services are structured to protect operations, strengthen decisions and support sustainable growth.
            </p>
          </ScrollView>
        </div>
