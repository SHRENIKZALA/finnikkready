...
import { Employee, Department, Knowledge } from '@/utils/hrm/types';
...
import { Command, CommandInput, CommandEmpty, CommandGroup, CommandItem } from "@/components/hrm/ui/command";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/hrm/ui/popover";
...
} from '@/utils/hrm/supabase/queries';
import { DepartmentSelect } from "@/components/hrm/ui/department-select";
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <div className="flex justify-end space-x-2">
                <Button type="button" variant="outline" onClick={() => router.push('/hrm/employees')}>Cancel</Button>
