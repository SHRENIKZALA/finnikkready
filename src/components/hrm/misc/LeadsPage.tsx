...
import { getLeadsList, getLeadMetrics } from '@/utils/hrm/supabase/queries';
import { Breadcrumb } from '@/components/hrm/ui/breadcrumb';
import { Progress } from "@/components/hrm/ui/progress";
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <Button 
              variant="ghost" 
              size="sm"
              onClick={() => router.push('/hrm/leads/pipeline')}
              className="ml-2"
            >
