...
import { getWorkScheduleType, addWorkScheduleType, updateWorkScheduleType } from '@/utils/hrm/supabase/queries';
...
export default function AddWorkScheduleTypeForm({ scheduleTypeId }: { scheduleTypeId: string | null }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/hrm/master/schedules');
      toast({
        title: "Success",
            ...
            <div className="grid gap-4">
              ...
              <div className="flex justify-end space-x-2">
                <Button 
                  type="button" 
                  variant="outline" 
                  onClick={() => router.push('/hrm/master/schedules')}
                >
                  Cancel
                </Button>
