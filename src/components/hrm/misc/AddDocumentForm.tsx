...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from '@/components/hrm/ui/dialog';
import { createClient } from '@/utils/hrm/supabase/client';
import { addLeadDocument, getActiveEmployees } from '@/utils/hrm/supabase/queries';
...
import { Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@/components/hrm/ui/select';
