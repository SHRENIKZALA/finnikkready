...
import { getPublicHolidays } from '@/utils/hrm/supabase/queries';
...
import { Dialog, DialogContent, DialogTrigger, DialogTitle } from "@/components/hrm/ui/dialog";
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link href="/hrm/master/holidays/add">
