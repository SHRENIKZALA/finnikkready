...
import { Autocomplete } from '@/components/hrm/ui/autocomplete';
...
import { Switch } from "@/components/hrm/ui/switch";
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4">
                ...
                <div className="flex justify-end space-x-2">
                  <Button type="button" variant="outline" onClick={() => router.push('/hrm/projects')}>Cancel</Button>
