...
import { getLeadActivities, LeadActivity } from '@/utils/hrm/supabase/queries';
...
import { DataFilter } from '@/components/hrm/ui/data-filter';
import { 
  Select,
  SelectContent,
  SelectItem,
