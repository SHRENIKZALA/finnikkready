...
import { getWorkLogs } from '@/utils/hrm/supabase/queries';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/hrm/ui/card';
...
import { DEFAULT_ITEMS_PER_PAGE } from '@/utils/hrm/constants';
import { useTenant } from '@/utils/hrm/tenant-context';
import { toast } from '@/components/hrm/ui/use-toast';
import { Badge } from '@/components/hrm/ui/badge';
...
import { Dialog, DialogTrigger, DialogContent, DialogTitle } from '@/components/hrm/ui/dialog';
import BulkImportWorkLogs from '@/components/hrm/misc/BulkImportWorkLogs';
import { Check, X } from 'lucide-react';
import { cn } from '@/utils/hrm/cn';
import { approveWorkLog, rejectWorkLog } from '@/utils/hrm/supabase/queries';
