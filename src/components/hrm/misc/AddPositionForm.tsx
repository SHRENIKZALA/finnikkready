...
import { getDepartments, addPosition, getPosition, updatePosition } from '@/utils/hrm/supabase/queries';
...
export default function AddPositionForm({ positionId }: { positionId: string | null }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/hrm/master/positions');
      toast({
        title: "Success",
            ...
            <div className="grid gap-4">
              ...
              <div className="flex justify-end space-x-2">
                <Button 
                  type="button" 
                  variant="outline" 
                  onClick={() => router.push('/hrm/master/positions')}
                >
                  Cancel
                </Button>
