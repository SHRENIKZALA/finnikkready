...
export function SignupForm() {
  ...
  return (
    <AuthPage
      description="Start a Finnikk Business OS workspace for GST-ready books and inventory."
    ...
    >
      <AuthForm onSubmit={(event) => void handleSubmit(event)}>
        ...
        <AuthFooterText>
          By creating an account, you agree to Finnikk Business OS handling your data as
          described in the{' '}
          <Link
            className="font-medium text-foreground underline-offset-4 hover:underline"
            to="/privacy"
