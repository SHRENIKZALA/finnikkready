...
const ALTERNATIVES_LIST: Array<Alternative> = [
  {
    ...
    seoDescription:
      'Switching off Tally? Finnikk Business OS runs in the browser, is free and open source, and covers GST billing, inventory, and party ledgers.',
    headline: 'A Tally alternative that runs in the browser, not just on the counter PC',
    intro:
      'Tally is a Windows desktop application with a paid, renewable license and no published source code. Finnikk Business OS is the opposite on every one of those points: it runs in any browser, ships as MIT-licensed open source, and can be self-hosted on Cloudflare Workers and Neon if you would rather not use the hosted version. Sales, purchases, inventory, party ledgers, and GST returns work the same way either way.',
    faq: [
      {
        question: 'Can I import my existing Tally data into Finnikk Business OS?',
        answer:
      ...
      {
        question: 'Does Finnikk Business OS work offline like Tally?',
        answer:
          'No. Finnikk Business OS is a browser-based, always-online workspace. If you self-host it, it runs on your own infrastructure, but it is still a web app, not an offline desktop program.',
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: 'Does Finnikk Business OS support multiple companies like Busy?',
        answer:
  ...
  },
  {
    ...
    intro:
      "Vyapar is billed as a subscription, and features like multi-company support are plan-dependent. Finnikk Business OS's core workflow — sales, purchases, GRN, inventory with godowns, and GST returns — is free on every account, with multi-company included from the start. It runs in the browser rather than as a phone-first app, and it is open source if you want to self-host.",
    faq: [
      {
        question: 'Can I import my existing Vyapar data into Finnikk Business OS?',
        answer:
      ...
      {
        question: 'Is Finnikk Business OS mobile-friendly like the Vyapar app?',
        answer:
          "Finnikk Business OS is a desktop-first, keyboard-driven browser workspace. It is usable on a phone browser, but the counter-PC voucher entry — the thing it's optimised for — is built for a keyboard.",
      },
    ],
  },
  {
    ...
    intro:
      'Zoho Books is a general cloud accounting product sold on a subscription, with multi-company support depending on the plan. Finnikk Business OS is purpose-built around the Indian GST billing workflow — CGST/SGST/IGST invoices, HSN summaries, GSTR-2B reconciliation — and is free and open source rather than subscription-based, with multi-company included on every account.',
    faq: [
      {
        question: 'Can I import my existing Zoho Books data into Finnikk Business OS?',
        answer:
      ...
      {
        question: 'Is Finnikk Business OS free the way Zoho Books free plan is?',
        answer:
          "Zoho Books' free plan is limited by invoice count and revenue. Finnikk Business OS's core billing, inventory, and GST reporting workflow has no license fee and no such usage cap.",
      },
    ],
  },
]
