export const SITE = {
  name: 'Finnikk Business OS',
  url: 'https://finnikkglobal.netlify.app',
  githubUrl: 'https://github.com/SHRENIKZALA/finnikkready',
  title: 'Finnikk Business OS — Free GST billing & accounting for Indian business',
  description:
  ...
  ogImage: 'https://finnikkglobal.netlify.app/og-card.png',
} as const
...
export const FAQ = {
  ...
  items: [
    {
      question: 'Is Finnikk Business OS really free?',
      answer:
    ...
    },
    {
      ...
      answer:
        'For filing strategy, notices, and advisory — yes, a CA remains valuable. Finnikk Business OS keeps books, invoices, and GST reports organised so your CA works from clean data rather than chasing WhatsApp photos.',
    },
  ],
} as const
