# Finnikk Business OS — GST Billing & Khata App

Finnikk Business OS is a modern **GST billing, khata ledger, and accounting app** for Indian businesses — sales invoicing, purchase bills, inventory, party ledger, payments, and **GST compliance** in one web and mobile workspace.
...
**Repository:** [github.com/SHRENIKZALA/finnikkready](https://github.com/SHRENIKZALA/finnikkready)
...
```bash
git clone https://github.com/SHRENIKZALA/finnikkready.git
cd finnikk-business-os
```
...
**Live example worker name:** `finnikk-business-os` (configure in `wrangler.jsonc`).
...
**Contributing:** Open an issue or PR on [GitHub](https://github.com/SHRENIKZALA/finnikkready).
...
1. Add the property for `https://finnikkglobal.netlify.app` at
...
3. Set `VITE_GOOGLE_SITE_VERIFICATION` to that value and rebuild/deploy —
   ...
   ```
4. Once verified, submit `https://finnikkglobal.netlify.app/sitemap.xml` under **Sitemaps**.

---

## Support

- **Issues:** [GitHub Issues](https://github.com/SHRENIKZALA/finnikkready/issues)
