...
const PRIVACY_POLICY_URL = 'https://finnikkglobal.netlify.app/privacy'
const DATA_DELETION_URL = 'https://finnikkglobal.netlify.app/data-deletion'
...
export default function LoginScreen() {
  ...
  return (
    <AuthShell title="Finnikk Business OS" subtitle="Sign in to your workspace">
      <FormField
        autoCapitalize="none"
